...
Object.defineProperty(ScienceBook, 'info', {
    ...
    // value: 'Інформація про наукову книгу', 
    // writable: false,  
    // configurable: false,
    // enumerable: true,
...
// Створюємо об'єкт Media
 const Media = {
    ...
    lenght: 0,
    play() {
        console.log(`Зараз відтворюється медіа у форматі ${Media.format} з тривалістю ${Media.lenght} секунд`)
    }
 }
/*
 * Об'єкт: Song
